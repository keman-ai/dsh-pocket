 ...
 *
 * Single-package repo, so the tag is just v<version>.
 */
...
sh('gh', ['release', 'create', tag, file,
  ...
  '--notes', [
    ...
    '',
    'Install (recommended, tracks master):',
    '```sh',
    ...
    '```',
    '',
    'Pocket ships switched off; enable it in the profile\'s cordis.patch.yml (see the README).',
  ].join('\n'),
])
